...
pub fn hashset(data: &[u8]) -> HashSet<u8> {
    HashSet::from_iter(data.iter().cloned())
}

pub fn jaccard_index(clusters1: &Vec<HashSet<u8>>, clusters2: &Vec<HashSet<u8>>) -> f64 {
...
pub fn rand_index(clusters1: &Vec<HashSet<u8>>, clusters2: &Vec<HashSet<u8>>) -> f64 {
    let (n11, n10, n01, n00) = count_pairwise_cooccurence(clusters1, clusters2);
